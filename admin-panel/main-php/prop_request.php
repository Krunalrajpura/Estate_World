    ...
    <div class="container">
        <div class="page-inner">
            ...
            ?>
                        ...
                        <div class="card card-stats card-round">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-7 col-stats">
                                        <div class="numbers">
                                            <a href="prop_details.php?p_id=<?php echo $p_id; ?>&c_id=<?php echo $c_id; ?>" title="View Details" class="card-title"><?php echo $c_name; ?></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-sm-6 col-md-1">
                        <div class="card card-stats card-round">
                            <div class="card-body">
                                <div class="row">
                                    <div class="d-flex justify-content-center">
                                        <button title="Accept" class="btn btn-outline-success btn-sm" data-toggle="modal" data-target="#acceptModalNo<?php echo $p_id; ?>"><i class="fa-regular fa-circle-check fs-5 mt-1"></i></button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6 col-md-1">
                        <div class="card card-stats card-round">
                            <div class="card-body">
                                <div class="row">
                                    <div class="d-flex justify-content-center">
                                        <button title="Reject" class="btn btn-outline-danger btn-sm" data-toggle="modal" data-target="#rejectModalNo<?php echo $p_id; ?>"><i class="fa-regular fa-circle-xmark fs-5 mt-1"></i></button>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <!-- Modal -->
                <div class="modal fade" id="acceptModalNo<?php echo $p_id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer d-flex justify-content-between">
                                <a href="prop_details.php?p_id=<?php echo $p_id; ?>&c_id=<?php echo $c_id; ?>" title="View Details" type="button" class="btn btn-info">View Details</a>
                                <div>
                                    <form action="<?php $_PHP_SELF ?>" method="POST">
                                        <input type="text" name="p_id" value="<?php echo $p_id; ?>" hidden>
                                        <button title="Accept Request" type="submit" name="accept" class="btn btn-success">Accept</button>
                ...
                <!-- Modal -->
                <div class="modal fade" id="rejectModalNo<?php echo $p_id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-footer d-flex justify-content-between">
                                ...
                                <div>
                                    <form action="<?php $_PHP_SELF ?>" method="POST">
                                        <input type="text" name="p_id" value="<?php echo $p_id; ?>" hidden>
                                        <button title="Reject Request" type="submit" name="reject" class="btn btn-danger">Reject</button>
